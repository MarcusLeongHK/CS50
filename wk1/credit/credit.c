...
//identifying the validity of the card and the type of card
    ...
    {
        if (credit >= 4000000000000 && credit < 5000000000000) //check for visa
        {
            printf("VISA\n");
        }
        else if (credit >= 4000000000000000 && credit < 5000000000000000)
        {
            printf("VISA\n");
        }
        ...
        else if ( (credit >= 340000000000000 && credit < 350000000000000) || (credit >= 370000000000000 && credit < 380000000000000) )
        {
            printf("AMEX\n");
        }
        else
